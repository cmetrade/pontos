...
# Valores e alta do DX
with open("arquivos/dx-max.txt", "r") as high:
        x1 = high.read()

with open("arquivos/dx-max-old.txt", "r") as highold:
        x2 = highold.read()
...
# Valores e baixa do DX

with open("arquivos/dx-min.txt", "r") as low:
        x3 = low.read()

with open("arquivos/dx-min-old.txt", "r") as lowold:
        x4 = lowold.read()
...
if alta1 != alta2:
    print('O valor do DX MAX é {:.3f}'.format(alta1))
    import requests
...
if baixa1 != baixa2:
    print('O valor do DX MIN é {:.3f}'.format(baixa1))
    import requests
    TOKEN = "5779297459:AAE2k4xaLnQZW0MRSmu0OX3UYftw7vZishg"
    chat_id = "-1001546918854"
